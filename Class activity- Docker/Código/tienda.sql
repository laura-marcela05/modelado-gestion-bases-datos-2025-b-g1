...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`productos_id`) REFERENCES `productos` (`id`)
...
INSERT INTO `productos` VALUES (1,'Celular',120.0),(2,'TV',410.0),(3,'Camisa',20.0),(4,'Agua',3.0),(5,'Leche',5.0);
...
INSERT INTO `usuarios` VALUES (1,'Marta','Penagos@gmail.com'),(2,'Julian','Rodriguez@gmail.com'),(3,'Lucia','Armenia@gmail.com'),(4,'Juan','Quintero@gmail.com'),(5,'Vanessa','Benel@gmail.com');
...
-- Dump completed on 2025-09-23 19:45:29
